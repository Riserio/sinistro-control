...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/alertas' | '/casco' | '/configuracoes' | '/esteira' | '/importar' | '/integral' | '/login'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/alertas' | '/casco' | '/configuracoes' | '/esteira' | '/importar' | '/integral' | '/login'
  id: '__root__' | '/' | '/alertas' | '/casco' | '/configuracoes' | '/esteira' | '/importar' | '/integral' | '/login'
